...
import br.com.mvbos.lgj.base.ImagemUtil;
import br.com.mvbos.lgj.base.SomUtil;
import br.com.mvbos.lgj.base.Tocador;
import br.com.mvbos.lgj.pacman.InicioCenario;
import br.com.mvbos.lgj.pacman.JogoCenario;
...
public class JogoView extends View {
    ...
    public static ImagemUtil getImagemUtil() {
        return imagemUtil;
    }
    ...
    public JogoView(Context context, int larguraTela, int alturaTela) {
        super(context);
        /* jogo feito para uma tela de  448x550 */
        this.larguraCena = 448;
        this.alturaCena = 550;
        ...
        imagemUtil = new ImagemUtil(context);
    }
